...
<body>
    <section id="nav">
        <article>
            ...
            <div class="menu">
                <div class="premium">
                    <a href="https://www.spotify.com/in-en/premium/" target="_blank">Premium</a>
                </div>
                <div class="support">
                    <a href="https://support.spotify.com/in-en/?_gl=1*siu7gg*_gcl_au*MTE3MDQxNzEzNS4xNzAxMjc4MTdivtarget=" target="_blank">Support</a>
                </div>
                <div class="download">
                    <a href="https://www.spotify.com/in-en/download/windows/" target="_blank">Download</a>
                </div>
                <div class="line">|</div>
                <div class="signup">
                    <a href="https://www.spotify.com/in-en/signup" target="_blank">Sign up</a>
                </div>
                <div class="login">
                    <a href="https://accounts.spotify.com/en/login?continue=https%3A%2F%2Fwww.spotify.com%2Fin-en%2Ffree%2F&_locale=en-IN" target="_blank">Login</a>
                </div>
            </div>
        </article>
    ...
    <section id="homepage2">
      <article>
        ...
        <div class="logo">
            ...
            <h4>Listen to the songs you love, and discover new music and podcasts.</h4>
            </div>
            <div>
                <img src="./assets/playlist.png" alt="">
                <h1>Playlists made easy.</h1>
                <h4>We'll help you make playlists. Or enjoy playlists made by music experts.</h4>
            </div>
            <div>
                <img src="./assets/make.png" alt="">
                <h1>Make it yours.</h1>
                <h4>Tell us what you like, and we'll recommend music for you.</h4>
            </div>
            <div>
                <img src="./assets/save.png" alt="">
                <h1>Save mobile data.</h1>
                <h4>To use less data when you play music, turn on Data Saver in Settings.</h4>
    ...
    <footer>
        <article>
            <div>
                <img src="./assets/logo-svg.png" alt="" height="40px">
            </div>
            <div>
                <ol class="about">
                    <li class="aboutall">COMPANY</li>
                    <li>About</li>
                    <li>job</li>
            ...
            <div >
                <ol class="communities">
                    <li class="communitiesHead">COMMUNITIES</li>
                    <li>For Artists</li>
                    <li>Developers</li>
                    <li>Advertising</li>
                    <li>Investors</li>
            ...
            <div>
                <ol class="useful">
                    <li class="usefullinks">USEFUL LINKS</li>
                    <li>Support</li>
                    <li>Web Player</li>
